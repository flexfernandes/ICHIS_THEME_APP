...
#   3. gf_theme.js     → aplica variáveis no :root via API
#   4. gf_overlay.js   → intercepta rota e renderiza overlay
# ──────────────────────────────────────────────────────────────
...
app_include_js = [
    "/assets/ichis_theme_app/js/gf_theme.js",
    "/assets/ichis_theme_app/js/gf_overlay.js",
]
