...
# ──────────────────────────────────────────────────────────────
app_include_css = [
    "/assets/ichis_theme_app/css/gf_theme.css?v=26",
    "/assets/ichis_theme_app/desk_modern/desk_modern.css?v=26",
]

app_include_js = [
    "/assets/ichis_theme_app/js/gf_theme.js?v=26",
    "/assets/ichis_theme_app/desk_modern/desk_modern.js?v=26",
]
